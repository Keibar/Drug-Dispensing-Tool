...
// Calculate total number of doctors
...
// Fetch doctors for the current page from the database
$doctors = array();
$conn = new mysqli($host, $username, $databasePassword, $databaseName);
if ($conn->connect_error) {
	die("Connection failed: " . $conn->connect_error);
} else {
	$sql = "SELECT * FROM doctor ORDER BY doctorId LIMIT $offset, $doctorsPerPage";
	$result = $conn->query($sql);
...
?>
	...
	<table class="table table-bordered table-striped">
		...
		<?php foreach ($doctors as $doctor) : ?>
			...
			<td><a href="../profiles/doctor_profile.php?doctorId=<?= $doctor['doctorId'] ?>"><?= $doctor['name'] ?></a></td>
	...
	<!-- Pagination -->
	<nav aria-label="Page navigation btn">
