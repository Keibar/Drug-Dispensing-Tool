...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
	...
	$stmt = $conn->prepare("INSERT INTO administrator (emailAddress, phoneNumber, gender, passwordHash) VALUES (?, ?, ?, ?)");
	$stmt->bind_param("ssss", $emailAddress, $phoneNumber, $gender, $passwordHash);
	...
	if ($stmt->execute()) {
		...
		echo "<script>alert('Administrator registered successfully!');</script>";
	} else {
		// Registration failed
